...
@testset "NL2 Hubbard fdPA" begin
    ...
    # Reference solution
    S0 = parquet_solver_hubbard_parquet_approximation_NL2(nG, nK1, nK2, nK3, mK_G, mK_Γ; T, U, μ, t1, mode = :threads)
    init_sym_grp!(S0)
    ...
    S0_fd = parquet_solver_hubbard_parquet_approximation_NL2(nG, nK1, nK2, nK3, mK_G, mK_Γ; T, U, μ, t1, mode = :threads)
    init_sym_grp!(S0_fd)
    ...
    μ_fd = 0.5
    t2_fd = -0.3
    S = parquet_solver_hubbard_parquet_approximation_NL2(nG, nK1, nK2, nK3, mK_G, mK_Γ; T, U, μ = μ_fd, t1, t2 = t2_fd, mode = :threads)
    init_sym_grp!(S)
    ...
    S_fd = NL2_ParquetSolver(nK1, nK2, nK3, mK_Γ, Gbare, S0.G, S0.Σ, S0.F; mode = :threads)
    init_sym_grp!(S_fd)
